...
public class SlowRateToCalleeChecker extends LongValueAlarmChecker {
    ...
    public String getEmailMessage() {
        return String.format(AlarmMessageConstant.SLOW_RATE_TO_CALLEE_CHECKER_EMAIL, rule.getCheckerName(), getDetectedValue(), unit, rule.getThreshold(), unit, rule.getCheckerName(), rule.getApplicationId(), rule.getNotes());
    }
